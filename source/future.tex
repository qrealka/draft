...
with a \tcode{BaseCharacteristic} of \tcode{true_type}
...
if and only \tcode{invoke_result<Fn, ArgTypes...>::type} is defined.
...
\rSec1[depr.locale.stdcvt]{Standard code conversion facets}
...
\rSec1[depr.conversions]{Deprecated character conversions}
