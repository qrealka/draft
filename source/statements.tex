...
\nontermdef{selection-statement}\br
    \terminal{if constexpr}\opt{} \terminal{(} init-statement\opt condition \terminal{)} statement\br
    \terminal{if constexpr}\opt{} \terminal{(} init-statement\opt condition \terminal{)} statement \terminal{else} statement\br
...
\begin{ncbnf}
\terminal{if constexpr}\opt{} \terminal{(} init-statement condition \terminal{)} statement
\end{ncbnf}
...
\terminal{\{}\br
\>init-statement\br
\>\terminal{if constexpr}\opt{} \terminal{(} condition \terminal{)} statement\br
\terminal{\}}
\end{ncbnftab}
...
\begin{ncbnf}
\terminal{if constexpr}\opt{} \terminal{(} init-statement condition \terminal{)} statement \terminal{else} statement
\end{ncbnf}
...
\terminal{\{}\br
\>init-statement\br
\>\terminal{if constexpr}\opt{} \terminal{(} condition \terminal{)} statement \terminal{else} statement\br
\terminal{\}}
\end{ncbnftab}
