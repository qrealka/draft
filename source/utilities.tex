...
the constructor that takes a pointer parameter
in the primary template
except that the following constraints
are added for it to participate in overload resolution
...
the constructors that take a pointer parameter
in the primary template
except that they
...
namespace std {
  ...
  template <class Fn, class... ArgTypes> class invoke_result;
