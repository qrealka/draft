...
refers to the \tcode{size_type} member type of the primary \tcode{unordered_set}
template.
...
refers to the \tcode{size_type} member type of the primary \tcode{unordered_multiset}
template.
